...
export const Button = ({
  ...
  <button
    className={cn(
      'inline-flex select-none items-center justify-center font-semibold transition-all duration-150 active:scale-[0.985]',
    ...
    {...rest}
  >
    {loading ? <Loader2 size={17} className="animate-spin" /> : leftIcon}
    {children}
    {!loading && rightIcon}
  </button>
);
